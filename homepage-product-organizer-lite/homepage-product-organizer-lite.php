...
function acs_enqueue_script_and_styles () {
	...
	wp_enqueue_script(
		'jQueryDataTables',
		plugins_url() . '/homepage-product-organizer-lite/assets/js/jquery.dataTables.js'
	);
	wp_enqueue_script(
		'jQueryshapeShift',
		plugins_url() . '/homepage-product-organizer-lite/assets/js/jquery.shapeshift.min.js'
	);
	wp_enqueue_style( 'jQueryDatabTablesCss',
					plugins_url() . '/homepage-product-organizer-lite/assets/style/jquery.dataTables.css'
	);
	wp_enqueue_style( 'acs_core_style',
					plugins_url() . '/homepage-product-organizer-lite/assets/style/css.css'
	);
